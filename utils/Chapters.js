  ...
  1: [
      {
          ...
          subtopics: [
              ...
              {
                  id: "1.2",
                  name: "Types of programming languages: low-level, mid-level, high-level programming languages.",
              },
              {
                  id: "1.3",
                  name: "Algorithm – concept of algorithm, pseudo-code convention like – assignment statements develop algorithm to solve simple problems.",
              },
              {
                  id: "1.4",
                  name: "Flowchart - concept of flowchart, symbols of flowchart",
              },
          ],
      },
      ...
      //end of chapter  1
      {
          ...
          subtopics: [
              {
                  id: "2.1",
                  name: "History of C, features of C",
              },
              {
                  id: "2.2",
              ...
              {
                  id: "2.3",
                  name: "Header files,Main function",
              },
              {
                  id: "2.4",
                  name: "Character set,Data types in C",
              },
              {
                  id: "2.5",
                  name: "Token, constant, variable, keywords and identifiers in C",
              },
              {
                  id: "2.6",
                  name: "Rules for constructing variable names,declaration of variables",
              },
              {
                  id: "2.7",
                  name: "Symbolic constant with example",
              },
              {
                  id: "2.8",
                  name: "Basic Input/Output:-Input and Output statements using printf ()and scanf(),Character Input/Output statements using getchar() and putchar(),formatted input and formatted output",
              },
      ...
      },
      {
          ...
          subtopics: [
              {
                  id: "3.1",
                  name: "Concept of operator, operand, unary and binary operator.",
              },
              {
                  id: "3.2",
              ...
              {
                  id: "3.3",
                  name: "Relational and logical operator",
              },
              {
                  id: "3.4",
                  name: "Assignment and equality operator",
              },
              {
                  id: "3.5",
              ...
              {
                  id: "3.7",
                  name: "Unary operator:++ and - -",
              },
              {
                  id: "3.8",
                  name: "Integer and float conversion, type conversion in expression.",
              },
              {
                  id: "3.9",
...

      {
          ...
          subtopics: [
              ...
              {
                  id: "4.2",
                  name: "Looping control structure-for loop,while loop,do-while loop,nesting of loop, break,continue and goto statement",
              },
              {
                  id: "4.3",
                  name: "Comparison of while and do-while loop",
              },
          ],
      },
...

      {
          ...
          subtopics: [
              {
                  id: "6.1",
                  name: "Introduction to function-Need of function,Definition, Advantages of function",
              },
              {
                  id: "6.2",
                  name: "Function handling-Function declaration, Function definition, Function call",
              },
              {
                  id: "6.3",
                  name: "Different types of functions:- Function with no argument and no return value, Function with no argument and with return value, Function with argument and0020with return value",
              },
              {
                  id: "6.4",
                  name: "Storage classes and scope of variable:- storage classes -auto,static,extern,register scope and visibility of variables –local and global variable",
              },
              {
                  id: "6.5",
                  name: "recursion concept with example2",
              },
          ],
      },
      //end of chapter 6
...

      {
          ...
          subtopics: [
              ...
              {
                  id: "7.2",
                  name: "Union-Introduction to union, Syntax with example",
              },
              {
                  id: "7.3",
                  name: "difference between structure and union",
              },
          ],
      },
...

      {
          ...
          subtopics: [
              {
                  id: "8.1",
                  name: "Introduction to pointer:-Need of pointer, Definition, Declaration and initialization of pointer",
              },
              {
                  id: "8.2",
                  name: "Accessing variables using pointer",
              },
              {
                  id: "8.3",
                  name: "Advantages of pointers",
              },
