  ...
  "1": [
    {
      ...
      "content": "Intro to C: Variables, data types, coding basics, problem-solving foundation",
      "subtopics": [
        {
          "id": "1.1",
    ...
    },
    {
      ...
      "content": "Variables, operations, control structures, functions, libraries; simplicity, efficiency, system-level programming.",
      "subtopics": [
        {
          "id": "2.1",
    ...
    },
    {
      ...
      "content": "C operators perform operations on variables, forming essential program-building expressions.",
      "subtopics": [
        {
          "id": "3.1",
    ...
    },
    {
      ...
      "content": "Conditional statements, loops, functions: vital for organized, efficient C programs",
      "subtopics": [
        {
          "id": "4.1",
    ...
    },
    {
      ...
      "content": "Arrays: Contiguous elements, accessed by index. Strings: Character arrays, text representation, null-terminated.",
      "subtopics": [
        {
          "id": "5.1",
    ...
    },
    {
      ...
      "content": "Custom code blocks for specific tasks, enhancing C program organization",
      "subtopics": [
        {
          "id": "6.1",
    ...
    },
    {
      ...
      "content": "Structures group data, unions share space for efficient memory management in C",
      "subtopics": [
        {
          "id": "7.1",
    ...
    },
    {
      "id": 8,
      "title": "Pointers",
      "content": "Pointers store memory addresses, enable efficient data manipulation in C programming",
      "subtopics": [
        {
          "id": "8.1",
    ...
    },
    {
      ...
      "content": "File I/O in C: read/write data using fopen(), fscanf(), fprintf(), fclose().",
      "subtopics": [
        {
          "id": "9.1",
  ...
  "2": [
    {
      ...
      "content": "JavaScript: dynamic web language; setup, variables, data types, operators, execution.",
      "subtopics": [
        {
          "id": "1.1",
    ...
    },
    {
      ...
      "content": "JavaScript: Control flow, functions, parameters, scope, arrow functions, 'this', 'arguments'.",
      "subtopics": [
        {
          "id": "2.1",
    ...
    },
    {
      ...
      "content": "JavaScript: Arrays organize values; Objects hold key-value pairs; JSON enables interchange.",
      "subtopics": [
        {
          "id": "3.1",
    ...
    },
    {
      ...
      "content": "JavaScript enables dynamic web interactivity through DOM manipulation and event handling.",
      "subtopics": [
        {
          "id": "4.1",
    ...
    },
    {
      ...
      "content": "JavaScript handles tasks concurrently via callbacks, promises, and Async/Await syntax.",
      "subtopics": [
        {
          "id": "5.1",
    ...
    },
    {
      ...
      "content": "JavaScript fundamentals, closures, modules, error handling for proficient development.",
      "subtopics": [
        {
          "id": "6.1",
  ...
  "3": [
    {
      ...
      "content": "CSS styles web content, separating design from structure for appealing sites.",
      "subtopics": [
        {
          "id": "1.1",
    ...
    },
    {
      ...
      "content": "CSS: Style, backgrounds, fonts, borders, layout, positioning for web page appeal",
      "subtopics": [
        {
          "id": "2.1",
    ...
    },
    {
      ...
      "content": "CSS: Layout (Flexbox/Grid), Responsive Design (Media Queries), Mobile-First, Visual Appeal",
      "subtopics": [
        {
          "id": "3.1",
    ...
    },
    {
      ...
      "content": "Enhance UX with pseudo-classes, transitions, animations, 3D effects, and transformations",
      "subtopics": [
        {
          "id": "4.1",
    ...
    },
    {
      ...
      "content": "Preprocessors enhance CSS; frameworks provide pre-built styles for efficient web development.",
      "subtopics": [
        {
          "id": "5.1",
    ...
    },
    {
      ...
      "content": "Optimize CSS for efficiency, maintainability, and fast loading",
      "subtopics": [
        {
          "id": "6.1",
  ...
  "4": [
    {
      ...
      "content": "Introduction to web apps: HTML, CSS, JavaScript, interactivity basics.",
      "subtopics": [
        {
          "id": "1.1",
    ...
    },
    {
      ...
      "content": "HTML: Foundation for web; tags define structure, content.",
      "subtopics": [
        {
          "id": "2.1",
    ...
    },
    {
      ...
      "content": "Images and links enhance web content for interaction.",
      "subtopics": [
        {
          "id": "3.1",
    ...
    },
    {
      ...
      "content": "Tables organize data: forms collect user input for interaction.",
      "subtopics": [
        {
          "id": "4.1",
    ...
    },
    {
      "id": 5,
      "title": "Frames",
      "content": "HTML frames are outdated, use CSS for modern layouts.",
      "subtopics": [
        {
          "id": "5.1",
    ...
    },
    {
      ...
      "content": "Embed multimedia, choose hosting wisely for website success.",
      "subtopics": [
        {
          "id": "6.1",
  ...
  "5": [
    {
      ...
      "content": "OOP: Objects, Classes, Encapsulation, Inheritance, Polymorphism, Reusability, Modularity.",
      "subtopics": [
        {
          "id": "1.1",
    ...
    },
    {
      ...
      "content": "C++: Versatile, Object-Oriented, Powerful, Widely Used Software Development Language",
      "subtopics": [
        {
          "id": "2.1",
    ...
    },
    {
      ...
      "content": "C++ functions: code blocks for organized, reusable, and readable tasks.",
      "subtopics": [
        {
          "id": "3.1",
    ...
    },
    {
      ...
      "content": "Class: blueprint, object: instance with data and methods.",
      "subtopics": [
        {
          "id": "4.1",
    ...
    },
    {
      ...
      "content": "Constructors create objects, destructors clean up resources on deletion",
      "subtopics": [
        {
          "id": "5.1",
    ...
    },
    {
      ...
      "content": "Operator overloading in C++ customizes built-in operators for user-defined types.",
      "subtopics": [
        {
          "id": "6.1",
    ...
    },
    {
      "id": 7,
      "title": "Inheritance",
      "content": "C++ inheritance forms hierarchies, enabling code reuse and organization",
      "subtopics": [
        {
          "id": "7.1",
    ...
    },
    {
      ...
      "content": "Pointers manage memory, virtual functions enhance code flexibility",
      "subtopics": [
        {
          "id": "8.1",
    ...
    },
    {
      ...
      "content": "C++ exception handling manages errors for program stability.",
      "subtopics": [
        {
          "id": "9.1",
  ...
  "6": [
    {
      "id": 1,
      "title": "Grammar",
      "content": "Understanding speech, tenses, voice, transformation, concepts, articles: Effective communication",
      "subtopics": [
        {
          "id": "1.1",
          "name": "Parts of Speech: Noun, Pronoun, Adjective, Verb, Adverb, Prepositions, Conjunctions, Interjections"
        },
        {
          "id": "1.2",
          "name": "Tenses"
        ...
        {
          "id": "1.4",
          "name": "Transformation of sentences: Assertive to exclamatory and viceversa 1) Affirmative to negative and vice- versa 2) Remove 'too' 3) Not only�but also 4) Question Tag"
        },
        {
          "id": "1.5",
          "name": "Articles"
    ...
    },
    {
      ...
      "content": "Create clear, concise messages and organize meeting topics",
      "subtopics": [
        {
          "id": "2.1",
    ...
    },
    {
      ...
      "content": "Write letters to request documents, report issues formally",
      "subtopics": [
        {
          "id": "3.1",
          "name": "Fomal Letters"
  ...
  "7": [
    {
      ...
      "content": "Sharing information with clarity, feedback, and audience consideration",
      "subtopics": [
        {
          "id": "1.1",
    ...
    },
    {
      ...
      "content": "Clear, educates, motivates, directs, persuades, interacts, achieves desired outcomes",
      "subtopics": [
        {
          "id": "2.1",
    ...
    },
    {
      ...
      "content": "Formal: Upward, Downward, Vertical, Horizontal. Informal: Grapevine for efficiency",
      "subtopics": [
        {
          "id": "3.1",
          "name": "Formal"
    ...
    },
    {
      ...
      "content": "Verbal and non-verbal communication are vital for understanding and expression",
      "subtopics": [
        {
          "id": "4.1",
    ...
    },
    {
      ...
      "content": "Physical, language, socio-psychological, semantic, and cross-cultural communication hurdles.",
      "subtopics": [
        {
          "id": "5.1",
    ...
    },
    {
      ...
      "content": "Social etiquette: ethics, phone, table manners, small talk, punctuality",
      "subtopics": [
        {
          "id": "6.1",
    ...
    },
    {
      ...
      "content": "Define, describe, and instruct objects for optimal utility",
      "subtopics": [
        {
          "id": "7.1",
  ...
  "8": [
    {
      ...
      "content": "Logarithms solve exponent equations; ln and log are common",
      "subtopics": [
        {
          "id": "1.1",
    ...
    },
    {
      ...
      "content": "Complex numbers extend math, resolve equations, offer diverse applications",
      "subtopics": [
        {
          "id": "2.1",
    ...
    },
    {
      ...
      "content": "Expands (a + b)^n, coefficients, general term, practical applications",
      "subtopics": [
        {
          "id": "3.1",
    ...
    },
    {
      ...
      "content": "Decompose complex rational functions for easier integration in maths.",
      "subtopics": [
        {
          "id": "4.1",
    ...
    },
    {
      ...
      "content": "Basic trig: ratios, degrees/radians, arcs, identities, allied/compound angles",
      "subtopics": [
        {
          "id": "5.1",
    ...
    },
    {
      ...
      "content": "Vector algebra: Scalars, vectors, operations, representation, applications in math/physics",
      "subtopics": [
        {
          "id": "6.1",
  ...
  "9": [
    {
      "id": 1,
      "title": "Determinants",
      "content": "Determinants are Quantitative measures in linear algebra, crucial for solving equations & transformations.",
      "subtopics": [
        {
          "id": "1.1",
          "name": "Definition of determinant, Expansion of determinants of order 2 and order 3."
        },
        {
          "id": "1.2",
        ...
        {
          "id": "1.3",
          "name": "Solution of simultaneous equationsin two or three unknowns, by Cramer�s Rule and Consistency of Equations"
        }
      ]
    },
    {
      "id": 2,
      "title": "Matrices",
      "content": "Matrices are arrays of numbers used for calculations. Operations, transformations, determinants, inverses crucial.",
      "subtopics": [
        {
          "id": "2.1",
          "name": "Definition and need of Matrices, Algebra(addition, subtraction,  multiplication) of matrices"
        },
        {
          "id": "2.2",
          "name": "Elementary row operations,Transpose of a matrix, Minor & cofactors of the elements of matrix, matrix of cofactors, Adjoint and inverse of a matrix"
        }
      ]
    },
    {
      "id": 3,
      "title": "Trignometry",
      "content": "Trigonometry involves compound angles, factorization, inverse functions, and fundamental identities.",
      "subtopics": [
        {
          "id": "3.1",
          "name": "Use Compound Angles for Multiple and sub-multiple Angles"
        },
        {
          "id": "3.2",
          "name": "Factorization Formulae and De-factorization Formulae"
        },
        {
          "id": "3.3",
          "name": " Definition of Inverse Trigonometric Functions.And Principle values of Inverse Trigonometric ratios"
        },
        {
          "id": "3.4",
          "name": "Principle values of Inverse Trigonometric ratios & Basic Identities and Relations  between Inverse Trigonometric Function"
        }
      ]
    }
  ],
  "10": [
    {
      ...
      "content": "Understand electronic components, passive/active, soldering for circuits reliability",
      "subtopics": [
        {
          "id": "1.1",
    ...
    },
    {
      ...
      "content": "Computer evolution, classifications, components, hardware, software overview",
      "subtopics": [
        {
          "id": "2.1",
    ...
    },
    {
      ...
      "content": "Word processing: create, format, edit documents with extensive tools",
      "subtopics": [
        {
          "id": "3.1",
    ...
    },
    {
      ...
      "content": "Create, edit, enhance, and format presentations with multimedia elements.",
      "subtopics": [
        {
          "id": "4.1",
    ...
    },
    {
      "id": 5,
      "title": "Spreadsheet",
      "content": "Spreadsheets: Create, edit, format, calculate, visualize, print data efficiently",
      "subtopics": [
        {
          "id": "5.1",
    ...
    },
    {
      ...
      "content": "Internet: servers, browsers, communication, data, education, websites � crucial modern tools.",
      "subtopics": [
        {
          "id": "6.1",
